...
python newFilesystemScrubber.py --template "../../docs/trial_folder_structure/SPANC.json" --patientData "data/spanc_patient.json" --rdsRoot "/Volumes/research-data/PRJ-RPL/2RESEARCH/1_ClinicalData" --outputPath "data/sql_output.sql"